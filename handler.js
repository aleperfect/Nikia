...
export async function handler(chatUpdate) {
  ...
  /* Creditos a Otosaka (https://wa.me/519926216018) */
  ...
  for (const nk of callUpdate) {
    if (nk.isGroup == false) {
      if (nk.status == 'offer') {
        ...
        const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;VALU 👑;;;\nFN:VALU 👑\nORG:VALU 👑\nTITLE:\nitem1.TEL;waid=519926216018:+51 992 621 601\nitem1.X-ABLabel:VALU 👑\nX-WA-BIZ-DESCRIPTION:[❗] ᴄᴏɴᴛᴀᴄᴛᴀ ᴀ ᴇsᴛᴇ ɴᴜᴍ ᴘᴀʀᴀ ᴄᴏsᴀs ɪᴍᴘᴏʀᴛᴀɴᴛᴇs.\nX-WA-BIZ-NAME:VALU 👑\nEND:VCARD`;
...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '*[ ⚠ ] Advertencia*', body: 'INKABOT', thumbnail: imagen1, sourceUrl: '51918436413'}}}}, aa);
